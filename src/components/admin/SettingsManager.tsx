...
const SETTINGS_TAB_IDS = ['seo', 'navigation', 'pages', 'advanced'] as const;
...
export const SettingsManager: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useWorkspaceTabParam(SETTINGS_TAB_IDS, 'seo');
  ...
  useApplyPendingAdminSection('/admin/settings', (id) => setActiveTab(id as typeof activeTab));
    ...
    <AdminWorkspaceShell
      ...
      headerAction={
        <>
          ...
          <AdminHeaderSave label={saveLabel} saving={isSaving} onClick={() => void handleSave()} />
        </>
      }
    >
      {activeTab === 'seo' && (
        <>
          ...
          >
            <AdminEditorSubsection title="Share preview">
              ...
              <AdminFieldGrid
                columns={3}
                className="admin-editor-fields--readable mt-[var(--editor-field-gap)]"
              >
