    ...
    >
      ...
      <div className="relative z-10 w-full px-5 sm:px-8 lg:px-12 xl:px-16 2xl:px-20 max-w-[1600px] mx-auto">
        <EditorialSectionHeader
          ...
          fallback={
            <>
              Latest <span className="editorial-accent">Automation Strategies</span>
            </>
          }
          eyebrowFallback="The Playbook"
          ledeFallback={DEFAULT_LEDE}
          centered
          className="playbook-section__header flex flex-col items-center text-center max-w-4xl mx-auto mb-12 sm:mb-14 lg:mb-16"
        />
