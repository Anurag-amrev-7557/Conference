      ...
      >
        <div className="bg-white p-12 sm:p-20 rounded-[48px] border border-border/40 shadow-alabaster">
          <div className="flex flex-col items-center mb-10">
            ...
            <span className="text-playbook text-accent mb-4 tracking-[0.6em]">Error Code 404</span>
            <h1 className="text-5xl sm:text-7xl font-serif italic text-text leading-none mb-6">Record Not Found</h1>
