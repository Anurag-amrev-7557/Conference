      ...
      <div className="blog-page overflow-x-hidden public-page-shell public-inner-page">
        <CatalogHero
          ...
          title={renderCatalogTitle(
            data.settings.catalogPages?.blog,
            <>
              Where builders <span className="editorial-accent">learn to ship</span>
            </>,
          )}
          lede={
          ...
          {loading ? (
            ...
            <div className="blog-empty">
              ...
              <p className="editorial-lede max-w-none">
                We&apos;re drafting new agentic AI guides. Check back soon—or explore the rest of
                the site.
              </p>
            ...
            <div className="blog-empty-filter">
              ...
              <p className="editorial-lede max-w-none">
                Try another category or clear your search to see everything in the library.
              </p>
              <button
                type="button"
